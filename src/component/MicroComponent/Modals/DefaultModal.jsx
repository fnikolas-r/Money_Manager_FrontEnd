...
import {setinputmodalstatus, resetinputmodal, modalbackto} from "../../../storage/slices/component.js";
...
export default function DefaultModal(props) {
    ...
    const {status,before} = modalInputOpen;
    ...
    return (
        <Transition.Root show={status} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" initialFocus={cancelButtonRef}
                    onClose={()=>{dispatch(resetinputmodal())}}>
