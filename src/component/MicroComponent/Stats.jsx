...
export default function Stats(props) {
  return (
    ...
    >
      <dt>
        <div className={`absolute rounded-md p-3 ${props.color ? 'bg-white text-black':'bg-indigo-500 text-white'}`}>
      ...
      <dd className="ml-16 pb-6 flex items-baseline sm:pb-7">
        <p className={`text-2xl font-semibold ${props.color? 'text-white':'text-gray-900'}`}>{new Intl.NumberFormat("id-ID", {
          style: "currency",
          currency: "IDR"
        }).format(props.total)}
